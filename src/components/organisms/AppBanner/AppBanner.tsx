  ...
  return (
    <div className="bg-[#faf4eb] w-full">
      <motion.section
        ...
        className="relative flex sm:flex-row flex-col justify-center sm:justify-between items-center bg-[#1B1212] bg-hero-image-mobile sm:bg-hero-image bg-cover bg-no-repeat bg-center mx-auto max-w-[2048px] h-[550px] sm:h-[750px] overflow-hidden"
      >
